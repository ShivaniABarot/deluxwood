...
Route::group(['middleware' => ['auth', 'isCustomer']], function () {
	...
	Route::get('/customer-draft', [App\Http\Controllers\frontend\DashboardController::class, 'customerDraft'])->name('customerDraft');
	...
	Route::get('/add-hinge', [App\Http\Controllers\frontend\DashboardController::class, 'add_hinge'])->name('add-hinge');
	Route::get('/quantity-minus', [App\Http\Controllers\frontend\DashboardController::class, 'quantity_minus'])->name('quantity-minus');
	Route::get('/quantity-plus', [App\Http\Controllers\frontend\DashboardController::class, 'quantity_plus'])->name('quantity-plus');
	Route::get('/quantity-update', [App\Http\Controllers\frontend\DashboardController::class, 'quantity_update'])->name('quantity-update');
	Route::get('/customer_note_update', [App\Http\Controllers\frontend\DashboardController::class, 'customer_note_update'])->name('customer_note_update');
	Route::get('/po_number_update', [App\Http\Controllers\frontend\DashboardController::class, 'po_number_update'])->name('po_number_update');
	Route::get('/designer_update', [App\Http\Controllers\frontend\DashboardController::class, 'designer_update'])->name('designer_update');
	Route::get('/delete-accessorie-from-draft-product', [App\Http\Controllers\frontend\DashboardController::class, 'deleteAccessorieFromDraftProduct']);
	Route::get('/add-accessorie-to-draft-product', [App\Http\Controllers\frontend\DashboardController::class, 'addaccessorieToDraftProduct'])->name('add-accessorie-to-draft-product');
	Route::get('/get-accessories-by-product', [App\Http\Controllers\frontend\DashboardController::class, 'getaccessoriesByProduct'])->name('get-accessories-by-product');
	Route::get('/edit-modification-info', [App\Http\Controllers\frontend\DashboardController::class, 'editModificationInfo']);
	Route::get('/get-modification-values', [App\Http\Controllers\frontend\DashboardController::class, 'getModificationValues']);
	Route::get('/delete-modification-from-draft-product', [App\Http\Controllers\frontend\DashboardController::class, 'deleteModificationFromDraftProduct']);
	Route::get('/add-modification-to-draft-product', [App\Http\Controllers\frontend\DashboardController::class, 'addModificationToDraftProduct'])->name('add-modification-to-draft-product');
	Route::get('/get-cutdepth-by-product', [App\Http\Controllers\frontend\DashboardController::class, 'getcutdepthByProduct'])->name('get-cutdepth-by-product');
	Route::get('/get-modifications-by-product', [App\Http\Controllers\frontend\DashboardController::class, 'getModificationsByProduct'])->name('get-modifications-by-product');
	Route::get('/store-draft-product', [App\Http\Controllers\frontend\DashboardController::class, 'store_draft_product'])->name('store-draft-product');
	Route::get('/updateSelectedCutDepth', [App\Http\Controllers\frontend\DashboardController::class, 'updateSelectedCutDepth'])->name('updateSelectedCutDepth');
	Route::get('/updateIsCutDepth', [App\Http\Controllers\frontend\DashboardController::class, 'updateIsCutDepth'])->name('updateIsCutDepth');
	Route::get('/update-servie-configuration', [App\Http\Controllers\frontend\DashboardController::class, 'updateServieConfiguration']);
	Route::get('/update-configuration', [App\Http\Controllers\frontend\DashboardController::class, 'updateConfiguration']);
	Route::post('/add-draft/change/{id}/{draft_style_id}', [App\Http\Controllers\frontend\DashboardController::class, 'change_draft_style_post'])->name('change_draft_style_post');
	Route::get('/door-style/change/{draft_style_id}', [App\Http\Controllers\frontend\DashboardController::class, 'change_draft_style_get'])->name('change_draft_style_get');
	Route::get('/delete-draft-style/{draft_style_id}', [App\Http\Controllers\frontend\DashboardController::class, 'delete_draft_style'])->name('delete-draft-style');
	Route::post('/add-draft', [App\Http\Controllers\frontend\DashboardController::class, 'CustomerDraftStyle'])->name('addDraft');
	Route::get('/draft/add/{customer_draft_id}', [App\Http\Controllers\frontend\DashboardController::class, 'addDraft'])->name('draft.add');
	Route::get('/door-style/{id}', [App\Http\Controllers\frontend\DashboardController::class, 'doorStyle'])->name('doorStyle');

	Route::Post('/store-shipping-information/{id}', [App\Http\Controllers\frontend\DashboardController::class, 'store_shipping_information']);
	Route::get('/create-shipping-information/{id}', [App\Http\Controllers\frontend\DashboardController::class, 'create_shipping_information']);

	Route::get('/get-products-by-sku-and-door-style', [App\Http\Controllers\frontend\DashboardController::class, 'getProductsBySku'])->name('new-draft');
Route::get('/get-draft-products', [App\Http\Controllers\frontend\DashboardController::class, 'get_draft_products'])->name('get-draft-products');
	...
	Route::get('/add-cart/{customer_draft_Id}', [App\Http\Controllers\frontend\DraftController::class, 'showProduct'])->name('add-cart');
