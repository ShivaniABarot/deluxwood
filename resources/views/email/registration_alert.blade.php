         ...
         <tbody>
            <tr>
               <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px; background: white;">
                  ...
                  <p style="font-size:14px;margin:25px 0 6px 0;"><span style="display:inline-block;min-width:146px">We wanted to let you know that a new user has registered on the DeluxeWood Cabinetry. Please review their details below:</span></p>
                  <p style="font-size:14px;margin:20 0 6px 0;"><b><span style="display:inline-block;min-width:146px">User Details::
                     </span></b>
                  </p>
                  ...
                  <p style="font-size:14px;margin:20 0 6px 0;"><span style="display:inline-block;min-width:146px">You may want to welcome them or check if any assistance is needed.
                     </span>
                  </p>
                     <p style="font-size:14px;margin:20 0 0 0;"><span style="display:inline-block;min-width:146px">Best regards,<br>The Deluxewood Team
                     </span>
                  </p>
               </td>
            </tr>
