            ...
            <tr>
               <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px; background: white;">
                  <p style="font-size:16px;margin:6 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">
                     Hello {{$customer_name}},</span>
                  </p>
                  <p style="font-size:14px;margin:25px 0 6px 0;"><span style="display:inline-block;min-width:146px">Exciting news! Your platform login credentials are now active. Start exploring our platform's features and benefits by logging in at <a href="https://deluxewoodexpress.com" target="_blank">https://deluxewoodexpress.com</a>.</span></p>
                  <p style="font-size:14px;margin:20 0 6px 0;"><span style="display:inline-block;min-width:146px">Thank you for choosing Deluxewood Cabinetry.
                     </span>
                  </p>
