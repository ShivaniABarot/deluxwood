            ...
            <tr>
               <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px; background: white;">
                  <p style="font-size:16px;margin:6 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">
                     Dear {{$custEmail->representative_name}},</span>
                  </p>
                  ...
                  <span style="font-size:14px;">
                    ...
                    PO Number: {{$custEmail->po_number}}<br>
                    @php
                    use Carbon\Carbon;
                    $_stockupdate = Carbon::parse($custEmail->created_at)->format('m-d-Y'); 
                     @endphp
                    ...
                    <br>
                     @if($custEmail->service_type == "Curbside Delivery")
                        Shipping Cost: $150<br>
                     @endif
                     @if($custEmail->service_type  == "In-house Delivery")
                  ...
                  <span style="font-size:14px;">
                     Shipping Method: {{$custEmail->service_type}}<br>
