         ...
         <tbody>
            <tr>
               <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px; background: white;">
                  ...
                  <p style="font-size:14px;margin:25px 0 6px 0;"><span style="display:inline-block;min-width:146px">We're thrilled to share that your customer group has been successfully updated to <b>{{$Gruop_name}}</b>. This ensures you receive tailored experiences and exclusive benefits.</span></p>
