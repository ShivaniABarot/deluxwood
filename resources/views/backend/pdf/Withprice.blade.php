         ...
         <div>
            ...
            <div style="width: 40%; padding-top: 10px;display: inline-block; margin-left: 6px;">
               <table width="100%" height="100%" style="border: 1px solid #000000; background-color: #CBCBCB;font-size: 10px;font-family: 'Open Sans', sans-serif;">
                  ...
                  <tr>
                     <td colspan="3" class="prc_cls" style="{{ $totalModificationPrice == 0 ? 'padding-top: 7px;' : '' }}">Accessories Price</td>
                  ...
                  <tr>
                     <td colspan="3" class="prc_cls" style="{{ ($totalModificationPrice == 0 && $totalAccessoriesPrice == 0 && $totalDoorStylePrice == 0) ? 'padding-top: 7px;' : '' }}">Cut Depth Price</td>
            ...
            <div style="width: 40%; padding-top: 15px;display: inline-block; margin-left: 6px;">
               <table width="100%" height="100%" style="border: 1px solid #000000;font-size: 10px;font-family: 'Open Sans', sans-serif;">
                  ...
                  <tr>
                     <td colspan="3" class="prc_cls" style="{{ $customer_draft->configuration != 'Unassembled' ? 'padding-top: 7px;' : '' }}">Group Discount</td>
                  ...
                  @if($customer_draft->service_type == "Curbside Delivery")
                  <tr>
                     <td colspan="3" class="prc_cls">Shipping Cost</td>
