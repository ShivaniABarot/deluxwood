	...
	<div class="row align-items-center">
		<div class="border-0 mb-4">
			<div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
				<h3 class="fw-bold mb-0">Door Style List</h3>
                <a href="{{url('admin/door-style-add')}}" class="btn btn-dark py-2 px-5 btn-set-task w-sm-100"><i class="icofont-plus-circle me-2 fs-6"></i> Add Door Style</a>
			</div>
		</div>
	</div> <!-- Row end  -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLiveLabel">Door Style</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete this door style?</p>
                </div>
...
<script>
   ...
   function deleteModal(id) {
     ...
     $('#yes').on('click', function(event){
         ...
         $.ajax({
             url: "{{ url('admin/door-style/delete') }}"+'/'+id,
             type: 'GET',
             dataType: 'html',
