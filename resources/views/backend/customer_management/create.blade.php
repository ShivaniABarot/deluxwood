	...
	<div class="row clearfix g-3">
		...
		<div class="col-lg-12 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h200">
			<div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 100rem;">
				<!-- Form -->
				<form class="row g-1 p-3 p-md-4" action="{{url('admin/customer/store')}}" enctype="multipart/form-data"  method="POST" id="CustomerForm">
                ...
                @csrf
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="contact_number"  class="form-control form-control-sm" placeholder="Enter Contact number">
               ...
               <div class="col-6">
                ...
                <div class="col-6">
                    <div class="mb-2">
                        ...
                        <input type="text" name="owner_phone"  class="form-control form-control-sm" placeholder="Enter Phone">
                ...
                <div class="col-6">
                    <div class="mb-2">
                        <label class="form-label">Email</label>
                        <input type="email" name="owner_email"  class="form-control form-control-sm" placeholder="Enter Email">
                ...
                <div class="col-6" style="margin-top:30px;">
					...
					<div class="col-12 text-center mt-4">
						<button type="submit" class="btn btn-lg btn-block btn-light lift text-uppercase" alt="SIGNUP">Submit</button>
					</div>
