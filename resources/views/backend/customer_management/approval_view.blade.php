				...
				<h3 class="fw-bold mb-0">Customer Details </h3>
				 <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('admin/approvals')}}">Approvals</a></li>
               ...
               <div class="col-6">
                ...
                <div class="col-6">
                    <div class="mb-2">
                        ...
                        <span style="padding-left: 15px;">{{$customer->tex_exempt_form}}</span><br>
                       
                            <a href="{{ asset('public/img/texExemptForm/' . $customer->tex_exempt_form) }}" class="btn btn-dark py-2 px-5 btn-set-task w-sm-100" style="margin-top: 10px;" download>Download Tax Exempt Form</a>
