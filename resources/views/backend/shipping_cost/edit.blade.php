...
<div class="row align-items-center">
		<div class="border-0 mb-4">
			<div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
				<h3 class="fw-bold mb-0">Edit Shipping Cost </h3>
	...
	<div class="row clearfix g-3">
		...
		<div class="col-lg-12 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h200">
			<div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 100rem;">
				<!-- Form -->
				<form class="row g-1 p-3 p-md-4" action="{{url('admin\shipping-cost\update')}}\{{$state->state_id}}" enctype="multipart/form-data"  method="POST" id="CustomerGroupingForm">
                @method('PATCH')
                @csrf
					...
					<div class="col-12">
						<div class="mb-2">
							...
							<input type="text" name="state_name" readonly value="{{$state->state_name}}"class="form-control form-control-sm" placeholder="Enter Name of Company" >
                            <span class="text-danger kt-form__help error state_name"></span>
						</div>
					</div>
                    <div class="col-6">
						<div class="mb-2">
							<label class="form-label">In-House Delivery Shipping Cost</label>
							<input type="text" name="in_house_shipping_cost"  value="{{$state->in_house_shipping_cost}}" class="form-control form-control-sm" placeholder="Enter In-House Delivery Shipping Cost">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="curbside_shipping_cost"   value="{{$state->curbside_shipping_cost}}" class="form-control form-control-sm" placeholder="Enter Contact number">
