	...
	<div class="row align-items-center">
		<div class="border-0 mb-4">
			<div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
				<h3 class="fw-bold mb-0">Shipping Cost </h3>
				<a href="{{url('admin/default-shipping-cost/edit')}}" class="btn btn-dark py-2 px-5 btn-set-task w-sm-100"> <i class="icofont-edit me-2 fs-6"></i> Default Shipping Cost</a>
				<!-- <div class="col-4">
					...
					<table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">
						<thead>
							<tr>
								<th>Id</th>
								<th>State Name</th>
								<th>In-House Delivery  shipping Cost</th>
								<th>Curbside Delivery Shipping Cost</th>
								<th>Action</th>
							</tr>
						</thead>
						<tbody class="testlist">
						    ...
						    <tr>
						        <td><strong>{{$val->state_id}}</strong></td>
						        <td>
						            {{$val->state_name}}
						        </td>
						        <td>{{$val->in_house_shipping_cost}}</td>
						        <td>{{$val->curbside_shipping_cost}}</td>
						        <td>
						            <div class="btn-group" role="group" aria-label="Basic outlined example">
						                <a href="{{url('admin/shipping-cost/edit')}}/{{$val->state_id}}" class="btn btn-outline-secondary"><i class="icofont-edit text-success"></i></a>
						            </div>
						        </td>
						    </tr>
						@endforeach
