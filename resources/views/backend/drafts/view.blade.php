    ...
    <div class="row clearfix g-3">
        <div class="col-lg-12">
            <div class="card mb-3">
                ...
                @foreach ($products as $doorStyleId => $product)
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="single-item active">
                                <div class="items-image">
                                    @php
                                        $doorStyle = \App\Models\DoorStyle::findOrFail($doorStyleId);
                                    @endphp
                                    <img 
                ...
                <div class="table-container">
                  ...
                  <thead>
                   ...
                   @php 
                    ...
                    if ($draftStyle->configuration === "Unassembled" && $unassembled_discount) {
                        ...
                        <div class="checkout-coupon">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    ...
                                    <textarea class="form-control" rows="3" readonly style="resize: none;">{{ $customer_draft->customer_note ?? '' }}</textarea> -->
                                </div>
                            </div>
                        </div>
