	...
	<div class="row align-items-center">
		<div class="border-0 mb-4">
			<div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
				<h3 class="fw-bold mb-0"> Add Accessory</h3>
	...
	<div class="row clearfix g-3">
		...
		<div class="col-lg-12">
			<div class="card mb-3">
				...
				<div class="card-body">
					<form action="{{ route('accessories.store') }}" method="POST" id="customergroupForm">
						@csrf
						<div class="row g-3 align-items-center">
							<div class="col-md-6">
								<label class="form-label">Enter Accessory Name <span class="text-danger">*</span></label>
								<input type="text" class="form-control" name="accessories_name" placeholder="Please enter Name" >
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" name="quantity" placeholder="Please enter Name" >
							...
							<div class="col-md-12" >
								...
								<textarea class="form-control" rows="3" name="accessories_description" placeholder="Please enter Description" style="resize: none;"></textarea>
