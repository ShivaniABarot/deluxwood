                                            ...
                                            <div class="tab-pane fade show active" id="nav-Preview1" role="tabpanel">
                                                <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                                                    <div class="toast-header">
                                                        <img src="{!! backendAssets('dist/assets/images/xs/avatar1.svg') !!}" class="avatar sm rounded me-2" alt="" />
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="nav-Preview2" role="tabpanel">
                                                <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                                                    <div class="toast-header">
                                                        <img src="{!! backendAssets('dist/assets/images/xs/avatar2.svg') !!}" class="avatar sm rounded me-2" alt="" />
                                                        <strong class="me-auto">Bootstrap</strong>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="nav-Preview3" role="tabpanel">
                                                <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                                                    <div class="toast-header">
                                                        <img src="{!! backendAssets('dist/assets/images/xs/avatar3.svg') !!}" class="avatar sm rounded me-2" alt="" />
                                                        <strong class="me-auto">Bootstrap</strong>
                                                ...
                                                <div class="p-3 bg-dark">
                                                    <div aria-live="polite" aria-atomic="true" style="position: relative; min-height: 200px;">
                                                        <div class="toast fade show" style="position: absolute; top: 0; right: 0;">
                                                            <div class="toast-header">
                                                                <img src="{!! backendAssets('dist/assets/images/xs/avatar10.svg') !!}" class="avatar sm rounded me-2" alt="" />
