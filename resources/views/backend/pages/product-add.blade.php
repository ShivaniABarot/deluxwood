													...
													<td>
														<div class="product-cart d-flex align-items-center">
															<div class="product-thumb">
																<img src="{!! backendAssets('dist/assets/images/product/upload.png') !!}" class="img-fluid avatar xl" alt="Product">
															</div>
														</div>
													</td>
													<td>
					...
					<div class="row g-3 mb-3">
						<div class="col-xxl-12 col-xl-12 col-lg-12">
							<div class="img-container">
								<img id="image" src="{!! backendAssets('dist/assets/images/product/cropimg-upload.jpg') !!}" class="img-responsive" alt="Picture">
							</div>
						</div>
						<div class="col-xxl-12 col-xl-12 col-lg-12">
...
<script src="{!! backendAssets('dist/assets/plugin/multi-select/js/jquery.multi-select.js') !!}"></script>
<script src="{!! backendAssets('dist/assets/plugin/bootstrap-tagsinput/bootstrap-tagsinput.js') !!}"></script>
