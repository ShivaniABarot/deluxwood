					...
					<table id="patient-table" class="table table-hover align-middle mb-0" style="width: 100%;">
						...
						<tbody>
							<tr>
								...
								<td>Alexander007</td>
								<td>
									<a class="btn btn-sm btn-white" href="{!! backendRoutePut('invoices') !!}"><i class="icofont-print fs-5"></i></a>
									<a class="btn btn-sm btn-white" href="{!! backendRoutePut('invoices') !!}"><i class="icofont-download fs-5"></i></a>
									<a class="btn btn-sm btn-white" href="{!! backendRoutePut('invoices') !!}"><i class="icofont-send-mail fs-4"></i></a>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><img src="{!! backendAssets('dist/assets/images/product/product-7.jpg') !!}" class="avatar lg rounded me-2" alt="profile-image"><span>Traveling bag</span></td>
								<td>May 16, 2021</td>
								<td>$370</td>
								<td>Sarahone</td>
								<td>
