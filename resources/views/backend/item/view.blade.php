    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                <h3 class="fw-bold mb-0"> View Item</h3>
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-6">
                                <div class="mb-2">
                                    ...
                                    <select class="form-control category" name="product_category_id" disabled>
                             ...
                             <div class="col-12">
                                <div class="mb-2">
                                    ...
                                    <select id="door_style_id" class="form-control form-control-sm" name="door_style_id[]" multiple disabled>
                                        <option value="">Please Select</option>
                            ...
                            <div class="col-6">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="product_name" value="{{$product->product_name}}" class="form-control form-control-sm" placeholder="Enter Product Name" disabled>
                                    <span class="text-danger kt-form__help error product_name"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Item Name </label>
                                <input type="text" class="form-control" value="{{$item->product_item_name}}" name="product_item_name" placeholder="Please enter Item Name" disabled>
                                <span class="text-danger kt-form__help error product_item_name"></span>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">SKU </label>
                                <input type="text" class="form-control" name="product_item_sku" value="{{$item->product_item_sku}}" disabled placeholder="Please enter SKU">
                                <span class="text-danger kt-form__help error product_item_sku"></span>
                            </div>

                            <div class="col-md-12">
                                <label class="form-label"> Description </label>
                                <textarea class="form-control" rows="3" name="description" disabled placeholder="Please enter  description" style="resize: none;"> {{$item->description}}</textarea>
                                ...
                                <div class="row dimension">
                                    <div class="col-2">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="item_length[]" value="{{$ItemDimensions->item_length}}" class="form-control form-control-sm item_length" disabled placeholder="Product Lenght" onclick="item_lengthClicked(this)">
                                    ...
                                    <div class="col-2">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="item_breadth[]" value="{{$ItemDimensions->item_breadth}}" class="form-control form-control-sm item_breadth" disabled placeholder="Product Breadth" onclick="item_breadthClicked(this)">
                                    ...
                                    <div class="col-2">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="item_height[]" value="{{$ItemDimensions->item_height}}" class="form-control form-control-sm item_height" disabled placeholder="Product Height" onclick="item_heightClicked(this)">
                                    ...
                                    <div class="col-2">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="item_weight[]" value="{{$ItemDimensions->item_weight}}" class="form-control form-control-sm item_weight" disabled placeholder="Product Weight" onclick="item_weightClicked(this)">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <select class="form-control category" id="finish_side" name="finish_side" disabled>
                                            <option value="">Please Select</option>
                            ...
                            <div class="row" id="finish_side_div" style="display:noen; margin-top:30px">
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="right_finish_side_price" value="{{$ProductItemFinishSide->right_finish_side_price == 0 ? 'N/A' :$ProductItemFinishSide->right_finish_side_price }}" class="form-control form-control-sm" disabled placeholder="$">
                                ...
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="left_finish_side_price" value="{{$ProductItemFinishSide->left_finish_side_price == 0 ? 'N/A' :$ProductItemFinishSide->left_finish_side_price }}" class="form-control form-control-sm" disabled placeholder="$">
                                ...
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="both_finish_side_price" value="{{$ProductItemFinishSide->both_finish_side_price == 0 ? 'N/A' :$ProductItemFinishSide->both_finish_side_price }}" class="form-control form-control-sm" disabled placeholder="$">
                            ...
                            <div class="row" id="finish_side_div" style=" margin-top:30px">
                                <div class="col-4">
                                    <div class="mb-2">
                                        <label class="form-label">Right Finish side Price</label>
                                        <input type="text" name="right_finish_side_price" class="form-control form-control-sm" disabled placeholder="$">
                                        <span class="text-danger kt-form__help error right_finish_side_price"></span>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="mb-2">
                                        <label class="form-label">Left Finish Side Price</label>
                                        <input type="text" name="left_finish_side_price" class="form-control form-control-sm" disabled placeholder="$">
                                        <span class="text-danger kt-form__help error left_finish_side_price"></span>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="mb-2">
                                        <label class="form-label">Both Finish Side Price</label>
                                        <input type="text" name="both_finish_side_price" class="form-control form-control-sm" disabled placeholder="$">
                                        <span class="text-danger kt-form__help error both_finish_side_price"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <select class="form-control category" id="hinge_side" name="hinge_side" disabled>
                                            <option value="">Please Select</option>
                            ...
                            <div class="row" id="hinge_side_div" style=" margin-top:30px">
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="right_hinge_side_price" value="{{$ProductItemHingeSide->right_hinge_side_price == 0 ? 'N/A' :$ProductItemHingeSide->right_hinge_side_price }}" class="form-control form-control-sm" disabled placeholder="$">
                                ...
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="left_hinge_side_price" value="{{$ProductItemHingeSide->left_hinge_side_price == 0 ? 'N/A' :$ProductItemHingeSide->left_hinge_side_price }}" class="form-control form-control-sm" disabled placeholder="$">
                                ...
                                <!-- <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="both_hinge_side_price" value="{{$ProductItemHingeSide->both_hinge_side_price == 0 ? 'N/A' :$ProductItemHingeSide->both_hinge_side_price }}" class="form-control form-control-sm" disabled placeholder="$">
                            ...
                            <div class="row" id="hinge_side_div" style=" margin-top:30px">
                                <div class="col-4">
                                    <div class="mb-2">
                                        <label class="form-label">Right Hinge side Price</label>
                                        <input type="text" name="right_hinge_side_price" class="form-control form-control-sm" disabled placeholder="$">
                                        <span class="text-danger kt-form__help error right_hinge_side_price"></span>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="mb-2">
                                        <label class="form-label">Left Hinge Side Price</label>
                                        <input type="text" name="left_hinge_side_price" class="form-control form-control-sm" disabled placeholder="$">
                                        <span class="text-danger kt-form__help error left_hinge_side_price"></span>
                                    </div>
                                </div>
                                <!-- <div class="col-4">
                                    <div class="mb-2">
                                        <label class="form-label">Both Hinge Side Price</label>
                                        <input type="text" name="both_hinge_side_price" class="form-control form-control-sm" disabled placeholder="$">
                                        <span class="text-danger kt-form__help error both_hinge_side_price"></span>
                                    </div>
                                </div> -->
                            </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="mb-2">
                                        <label class="form-label">Do you want to add Cut Depth ? </label>
                                        <select class="form-control category" id="cut_depth" name="cut_depth" disabled>
                                            <option value="">Please Select</option>
                            ...
                            <div class="row" id="cut_depth_div" style=" margin-top:30px">
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="cut_depth_price" value="{{$item->cut_depth_price}}" class="form-control form-control-sm" disabled placeholder="$">
                                ...
                                <div class="col-8">
                                    <div class="mb-2">
                                        ...
                                        @endphp
                                        <input class="form-control tagify-input" value="{{$depthValues}}" id="depth_name_inch" name="depth_name_inch[]" disabled>
                            ...
                            <div class="row" id="cut_depth_div" style=" margin-top:30px">
                                <div class="col-4">
                                    <div class="mb-2">
                                        <label class="form-label">Cut Depth Price</label>
                                        <input type="text" name="cut_depth_price" class="form-control form-control-sm" disabled placeholder="$">
                                        <span class="text-danger kt-form__help error cut_depth_price"></span>
                                    </div>
                                </div>
                                <div class="col-8">
                            ...
                            <div class="col-4">
                                <div class="mb-2">
                                    <label class="form-label">Do you want to add Increase Depth ? <span class="text-danger">*</span></label>
                                    <select class="form-control category" id="increase_depth" name="increase_depth" disabled>
                                        <option value="">Please Select</option>
                                        @if($item->increase_depth == "Yes")
                                            <option value="Yes" selected>Yes</option>
                                            <option value="No">No</option>
                                        @elseif($item->increase_depth == "No")
                                            <option value="Yes">Yes</option>
                                            <option value="No" selected>No</option>
                                        @else
                                            <option value="Yes">Yes</option>
                                    ...
                                    <span class="text-danger kt-form__help error increase_depth"></span>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-2">
                                    <label class="form-label">Do you want to add Cut Height ? <span class="text-danger">*</span></label>
                                    <select class="form-control category" id="cut_height" name="cut_height" disabled>
                                        <option value="">Please Select</option>
                                        @if($item->cut_height == "Yes")
                                            <option value="Yes" selected>Yes</option>
                                            <option value="No">No</option>
                                        @elseif($item->cut_height == "No")
                                            <option value="Yes">Yes</option>
                                            <option value="No" selected>No</option>
                                        @else
                                            <option value="Yes">Yes</option>
                                    ...
                                    <span class="text-danger kt-form__help error cut_height"></span>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-2">
                                    <label class="form-label">Do you want to add Increase Height ? <span class="text-danger">*</span></label>
                                    <select class="form-control category" id="increase_height" name="increase_height" disabled>
                                        <option value="">Please Select</option>
                                        @if($item->increase_height == "Yes")
                                            <option value="Yes" selected>Yes</option>
                                            <option value="No">No</option>
                                        @elseif($item->increase_height == "No")
                                            <option value="Yes">Yes</option>
                                            <option value="No" selected>No</option>
                                        @else
                                            <option value="Yes">Yes</option>
                                    ...
                                    <span class="text-danger kt-form__help error increase_height"></span>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-2">
                                    <label class="form-label">Modification </label>
                                    <!-- <input type="text" name="representative_name"  class="form-control form-control-sm" disabled placeholder="Enter Representative Name"> -->
                                    <select id="selectBox" class="form-control form-control-sm" name="modification_id[]" multiple disabled>
                                        <option value="">Please Select</option>
                            ...
                            <div class="col-12">
                                <div class="mb-2">
                                    ...
                                    <select id="accessories_id" class="form-control form-control-sm" name="accessories_id[]" multiple disabled>
                                        <option value="">Please Select</option>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <input type="number" name="quantity" class="form-control form-control-sm" disabled value="{{$product->inventory_quantity}}" placeholder="Enter Quantity">
                            ...
                            <div class="col-6">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="product_item_price" value="{{$item->product_item_price}}" class="form-control form-control-sm" disabled placeholder="$">
...
<script>
    ...
    function updateTextBox() {
        ...
        for (let i = 0; i < totalSelectedOptions; i++) {
            ...
            const label = selectBox.find(`option[value="${option}"]`).text();
            const inputValue = i < itemModificationPriceJson.length ? itemModificationPriceJson[i] : '';

            const input_div = `<div class="col-4">
                                    <div class="mb-2">
                                        <label class="form-label">${label} Price</label>
                                        <input type="text" name="modification_price[]" class="form-control form-control-sm" placeholder="Price" value="${inputValue}" disabled>
...
<script>
    ...
    $(document).ready(function() {
        $('#door_style_id').select2();
        $('#door_style_id').val(@json($door_style_ids)).trigger('change');
    });

    // Function to update the text box content
    $(document).ready(function() {
        const inputValuesD = {}; // Define inputValues here
    function updateDoorBox() {
        const selectBox = $('#door_style_id');
        const selectedOptions = selectBox.val();
        ...
        const productDoorstylePriceJson = @json($door_style_Price);
        const totalSelectedOptions = selectedOptions.length;

        for (let i = 0; i < totalSelectedOptions; i++) {
            const option = selectedOptions[i];
            const label = selectBox.find(`option[value="${option}"]`).text()+"  Price";
            const inputValue = inputValuesD[label] || (i < productDoorstylePriceJson.length ? productDoorstylePriceJson[i] : '');
            const input_div = `<div class="col-3">
                                    <div class="mb-2">
                                        <label class="form-label">${label}</label>
                                        <input type="text" name="doorstyle_price[]" class="form-control form-control-sm" placeholder="Price" value="${inputValue}" disabled>
    ...
    function updateAccessoriesTextBox() {
        ...
        for (let i = 0; i < totalSelectedOptions; i++) {
            ...
            const input_div = `<div class="col-4">
                                    <div class="mb-2">
                                        <label class="form-label">${label} Price</label>
                                        <input type="text" name="accessories_price[]" class="form-control form-control-sm" placeholder="Price" value="${inputValue}" disabled>
