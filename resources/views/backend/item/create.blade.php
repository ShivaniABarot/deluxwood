    ...
    <div class="row clearfix g-3">
        ...
        <div class="col-lg-12">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form action="{{url('admin/item-store')}}" method="POST" id="customergroupForm" enctype="multipart/form-data">
                        @csrf
...
//class="btn btn-lg btn-block btn-danger lift text-uppercase remove_button"
        ...
        function validateDimension() {
            ...
            $('.dimension').each(function() {
                ...
                //     $(item_price).siblings('.item_price_error').html("Please Enter  Price");
                // } else if (!numberRegex.test(item_price.val())) {
                //     isValid = false;
                //     item_price.siblings('.item_price_error').html("Price must be a number");
                // }
  ...
  if (parseInt(fileInput.files.length) > 10) {
    ...
    for (let file of fileInput.files) {
      ...
      if (!file.type.match('image.*')) {
        $('#product_image_error').show();
        $('#product_image_error').html("Invalid file format. Please upload an image file.");
      } else {
