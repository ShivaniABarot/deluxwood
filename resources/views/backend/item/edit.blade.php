                ...
                <h3 class="fw-bold mb-0"> Edit Item</h3>
                 <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page" style="background: none; border: none;">Edit Item</li>
                        </ol>
                    </nav>
            </div>
        </div>
    ...
    <div class="row clearfix g-3">
        ...
        <div class="col-lg-12">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form action="{{url('admin/item/update')}}/{{$id}}" method="POST" id="customergroupForm" enctype="multipart/form-data">
                    @method('PATCH')
                        @csrf
                        <div class="row g-3 align-items-center">
                            ...
                            <!-- <div class="col-6">
                                <div class="mb-2">
                                    <label class="form-label">Door Style <span class="text-danger">*</span></label>
                                        <select id="mySelect" multiple="multiple" style="width: 463px;" id="door_style_id" name="door_style_id[]">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="product_item_sku" value="{{$item->product_item_sku}}" placeholder="Please enter SKU">
                                <span class="text-danger kt-form__help error product_item_sku"></span>
                            </div>

                           <div class="col-md-12">
    <label class="form-label"> Description </label>
    <textarea class="form-control" rows="3" name="description" placeholder="Please enter Description" style="resize: none;">{{ old('description', $item->description) }}</textarea>
    <span class="text-danger kt-form__help error description"></span>
                                ...
                                <div class="row dimension">
                                    ...
                                    <div class="col-2">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="item_breadth[]" value="{{$ItemDimensions->item_breadth}}" class="form-control form-control-sm item_breadth" placeholder="Product Depth" onclick="item_breadthClicked(this)">
                            ...
                            <div class="row" id="finish_side_div" style="display:noen; margin-top:30px">
                                ...
                                <div class="mb-2">
                                    <div class="toggle-button-container service_type">
                                        <button type="button" class="toggle-button @if($ProductItemFinishSide && $ProductItemFinishSide->finish_side_none == 'Yes' ) active  @endif "  id="finish_side_button" onclick="toggleActive('finish_side_button')">None</button>
                                    </div>
                                    <input type="hidden" id="finish_side_input" name="finish_side_none"  value="{{$ProductItemFinishSide ? $ProductItemFinishSide->finish_side_none : ''}}">
                                    </div>
                                </div>  
                            </div>
                            @else
                            ...
                            <div class="col-4">
                                <div class="mb-2">
                                    ...
                                    <select class="form-control category" id="increase_depth" name="increase_depth">
                                        <option value="">Please Select</option>
                            ...
                            <div class="col-4">
                                <div class="mb-2">
                                    ...
                                    <select class="form-control category" id="cut_height" name="cut_height">
                                        <option value="">Please Select</option>
                            ...
                            <div class="col-4">
                                <div class="mb-2">
                                    ...
                                    <select class="form-control category" id="increase_height" name="increase_height">
                                        <option value="">Please Select</option>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <input type="number" name="quantity" class="form-control form-control-sm"  value="{{$product->inventory_quantity}}" placeholder="Enter Quantity">
        ...
        for (let i = 0; i < totalSelectedOptions; i++) {
            ...
            const input_div = `<div class="col-3">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="doorstyle_price[]" class="form-control form-control-sm" placeholder="Price" value="${inputValue}">
