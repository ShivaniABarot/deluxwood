	...
	<div class="row align-items-center">
		<div class="border-0 mb-4">
			<div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
				<h3 class="fw-bold mb-0">Account Manager </h3>
				<div class="col-auto d-flex w-sm-100">
					<a href="{{url('admin/agent-add')}}" class="btn btn-dark btn-set-task w-sm-100" ><i class="icofont-plus-circle me-2 fs-6"></i>Add Account Manager</a>
				</div>
			</div>
		</div>
	</div> <!-- Row end  -->
						...
						<tbody>
							...
							<tr> 
								...
								<td>
									...
									<a type="button" class="btn btn-outline-secondary" href="{{url('admin\agent-view')}}\{{$agent->agent_id}}" ><i class="icofont-eye text-warning"></i></a>
										<a type="button" class="btn btn-outline-secondary" href="{{url('admin\agent-edit')}}\{{$agent->agent_id}}" ><i class="icofont-edit text-success"></i></a>
										<a href="javascript:void(0)" onclick="deleteModal('{{$agent->agent_id}}');" class="btn btn-outline-secondary"><i class="icofont-ui-delete text-danger"></i></a>
									</div>
								</td>
							</tr>
							@endforeach
