		...
		<div class="border-0 mb-4">
			<div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
				...
				<!-- <div class="col-auto d-flex w-sm-100">
					<a href="{{url('admin/agent-add')}}" class="btn btn-dark btn-set-task w-sm-100" ><i class="icofont-plus-circle me-2 fs-6"></i>Add Agent</a>
				</div> -->
			</div>
		</div>
	</div> <!-- Row end  -->
							...
							<tr> 
								...
								<td>
									<div class="btn-group" role="group" aria-label="Basic outlined example">
										<a type="button" class="btn btn-outline-secondary" href="{{url('admin\agent-assign')}}\{{$customer->customer_id}}" ><i class="icofont-edit text-success"></i></a>
									</div>
								</td>
							</tr>
							@endforeach
