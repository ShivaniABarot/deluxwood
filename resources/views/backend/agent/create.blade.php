...
@section('title', 'Account Manager Add ')
@section('content')
<div class="container-xxl">
   <div class="row align-items-center">
      <div class="border-0 mb-4">
         <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
            <h3 class="fw-bold mb-0"> Add Account Manager</h3>
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="{{url('admin/home')}}">Home</a></li>
                  <li class="breadcrumb-item"><a href="{{url('admin/agent-list')}}">Account Manager</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Add Account Manager</li>
               </ol>
            </nav>
         </div>
      </div>
   ...
   <div class="row clearfix g-3">
      <div class="col-lg-12">
         <div class="card mb-3">
            ...
            <div class="card-body">
               <form action="{{url('admin/agent-store')}}" method="POST" id="customergroupForm" enctype="multipart/form-data">
                  @csrf
                  <div class="row g-3 align-items-center">
                     <div class="col-md-4">
                        <label class="form-label"> Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="name" placeholder="Please enter Agent Name">
