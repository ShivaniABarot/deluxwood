   ...
   <body>
      ...
      <main>
         ...
         <!-- changes on 10/10/2024 -->
            ...
            <!-- changes end on 10/10/2024 -->
            <div class="thn_cls" style="font-size: 13px;">
               <b>Terms & Conditions:</b> 
               <br>
         ...
         <!-- <div style="width: 40%; padding-top: 15px;display: inline-block; margin-left:420px;" class="float-left">
         <table width="100%" height="100%" style="border: 1px solid #000000;font-size: 10px;font-family: 'Open Sans', sans-serif;">
            
            <tr style="padding:5px">
               <td colspan="3" class="prc_cls" style="padding-bottom: 7px;width: 70%; font-size:16px;"><b>Grand Total :</b> </td>
