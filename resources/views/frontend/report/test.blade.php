...
<div class="container-xxl">
   ...
   <label class="form-label" name="draft_id" style="margin-left:25px;">Order Tag: {{$customer_draft->order_tag}} </label>
   <!-- Row end  -->
               ...
               <div class="checkout-coupon-total checkout-coupon-total-2 d-flex flex-wrap mt-2">
                  ...
                  <div class="checkout-total">
                     ...
                     <div class="single-total">
                        ...
                        <p class="value">Tax:</p>
                        <p class="price" id="discount">{{$taxGroup->tax_rate}}%</p>
                        @endif
                     </div>
                     <div class="single-total">
...
<div class="row g-3 mb-3" id="invoice1" style="display: none;margin-top:10px;margint-bottom:20px;">
   <div class="col-md-12">
      <div class="card" style="border-color: #FFFFFF;">
         <div class="card-body">
            <div class="col-md-12 ">
               <div class="row">
                  ...
                  <div class="col-md-5 bllvr_cls" style="margin-top:-3px;">
                     <p class="title" style="border-bottom: 1px solid #000000; padding: 2px 3px 7px 13px;font-size: 16px;font-weight: Bold;">Sales Order - #{{$customer_draft_Id}}</p>
         ...
         <table style="margin-left: 2px;border-collapse: collapse;" class="ppd_cls">
            <tr>
         ...
         <div class="col-md-12" style="margin-top: 120px;">
            <div class="row">
               <div class="col-md-8 resp_cls" style="padding-right: 0px;height: 76px;">
                  <div class="grd_cls" style="padding: 4px 5px 0px 9px;border: 1px solid #000000;">
                     <p class="" style="font-size: 8px;font-weight: 600;text-align: center;">
                        No additional orders will be accepted untill fees have been paid or orders picked up.
                     <div class="row">
                        <div class="col-md-3"></div>
                        <div class="col-md-3 text-center" style="border-right: 2px solid;font-size: 8px;font-weight: 600;">
                           Pick Up Hours:<br>
                           Mon-Thurs: 9am-4pm<br>
                           Friday: 9am-11am                                    
                        </div>
                        <div class="col-md-3 text-center" style="font-size: 8px;font-weight: 600;">
                           Delivery Hours:<br>
                           Monday - Friday:<br>
                           9am-5pm
                        </div>
               ...
               <div class="col-md-4" style="padding-left: 0px; height: 76px;">
...
<div class="row g-3 mb-3" id="invoice" style="display: block;margint-bottom:20px;">
   <div class="col-md-12">
      <div class="card" style="border-color: #FFFFFF;">
         <div class="card-body">
      ...
      <div class="content-section">
         ...
         <div style="border: 1px solid #000000;margin-top: 50px;">
            <p class="thn_cls" style="font-size: 10px; font-weight: 600;">* The estimated time your order will be ready for pick up is 5 BUSINESS DAYS Excluding Holidays Closing Days from the time we receive your signature.                       
               <br><br>
               - - Signatures received after 10am will be considered as received on the next business day. Signatures received on Friday’s after 9:30am will be considered as received on next business day - -
               <br><br>
