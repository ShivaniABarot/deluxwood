...
<div class="container-xxl">
   ...
   <label class="form-label" name="draft_id" style="margin-left:8px;">PO: {{$customer_draft->po_number}} </label>
   <label class="form-label" name="draft_id" style="margin-left:25px;">Draft Number: {{$customer_draft_Id}} </label>
   <label class="form-label" name="draft_id" style="margin-left:25px;">Designer: {{$customer_draft->designer}} </label>
   @if (session('success'))
...
<img 
    ...
    style="width: 185px; height: 210px; border-radius: 8px; box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.08); border: 1px solid var(--border-color); cursor: pointer;">
            ...
            <!-- $configurationDiscount = $door_style_total * ($unassembled_discount->unassembled_discount / 100);  -->
            @php 
            ...
            <div class="product-cart">
                  ...
                  <div class="card-body">
                     ...
                     <div class="row g-3 align-items-center">
                        <div class="col-md-6">
                              ...
                              <input type="text" class="form-control" name="showroom"  value="{{$customer_draft->showroom}}"id="showroom" placeholder="please enter showroom">
                              <span class="text-danger kt-form__help error showroom"></span>
                              <span id="showroom_error" class="error text-danger"></span><br>
                           </div>
                           <!-- <div class="col-md-6">
                              <label class="form-label">Designer</label>
                              <input type="text" class="form-control" name="designer" value="{{$customer_draft->designer}}" id="designer" placeholder="please enter designer">
                              <span class="text-danger kt-form__help error designer"></span>
                              <span id="designer_error" class="error text-danger"></span><br>
                           </div> -->
                           <div class="col-md-4">
                           ...
                           <div class="col-md-4">
                              ...
                              <input type="text" class="form-control" name="client_name" id="client_name" value="{{$customer_draft->client_name}}" placeholder="please enter client name">
                           ...
                           <div class="col-md-4">
                              ...
                              <input type="text" class="form-control" name="client_email" id="client_email" value="{{$customer_draft->client_email}}" placeholder="please enter client email">
                        ...
                        <div class="col-md-8">
                              ...
                              <input type="text" class="form-control" name="address" value="{{$customer_draft->address}}" id="address" placeholder="please enter address">
                              <span class="text-danger kt-form__help error address"></span>
                              <span id="address_error" class="error text-danger"></span><br>
                        </div>
                        <div class="col-md-4">
                              <label class="form-label">Contact No</label>
                              <input type="text" class="form-control" name="contact_no" value="{{$customer_draft->contact_no}}" id="contact_no" placeholder="please enter contact">
                        ...
                        <div class="col-md-4">
                              ...
                              <span id="state_error" class="error text-danger"></span><br>
                        </div>
                        <div class="col-md-4">
                              <label class="form-label">City</label>
                              <input type="text" class="form-control" name="city" id="city"  value="{{$customer_draft->city}}"placeholder="please enter city">
                        ...
                        <div class="col-md-4">
                              ...
                              <input type="text" class="form-control" name="zip_code" id="zip_code" value="{{$customer_draft->zip_code}}" placeholder="please eneter zip code">
                        ...
                        <div class="col-md-4">
                              ...
                              <input type="text" class="form-control" name="ship_name" id="ship_name" value="{{$customer_draft->ship_name}}" placeholder="please enter contact">
                              <span class="text-danger kt-form__help error ship_name"></span>
                              <span id="ship_name_error" class="error text-danger"></span><br>
                        </div>
                        <div class="col-md-4">
                              <label class="form-label">Email</label>
                              <input type="text" class="form-control" name="ship_email" id="ship_email" value="{{$customer_draft->ship_email}}" placeholder="please enter contact">
                              <span class="text-danger kt-form__help error ship_email"></span>
                              <span id="ship_email_error" class="error text-danger"></span><br>
                        </div>
                        <div class="col-md-4">
                              <label class="form-label">Contact No</label>
                              <input type="text" class="form-control" name="ship_contact_no" id="ship_contact_no" value="{{$customer_draft->ship_contact_no}}" placeholder="please enter contact">
                        ...
                        <div class="col-md-8">
                              <label class="form-label">Address</label>
                              <input type="text" class="form-control" name="ship_address"  id="ship_address" value="{{$customer_draft->ship_address}}" placeholder="please enter address">
                        ...
                        <div class="col-md-4">
                              <label class="form-label">City</label>
                              <input type="text" class="form-control" name="ship_city" id="ship_city" value="{{$customer_draft->ship_city}}" placeholder="please enter city">
                        ...
                        <div class="col-md-4">
                              <label class="form-label">Zip Code</label>
                              <input type="text" class="form-control" name="ship_zip_code" id="ship_zip_code" value="{{$customer_draft->ship_zip_code}}" placeholder="please eneter zip code">
               ...
               <div class="checkout-coupon-total checkout-coupon-total-2 d-flex flex-wrap mt-2">
                  ...
                  <div class="checkout-total">
                     ...
                     $used_coupon= DB::table('used_coupon_history')->leftJoin('coupon_master', 'coupon_master.coupon_id', '=', 'used_coupon_history.coupon_id')->select('coupon_master.coupon_name','coupon_master.discount_type','used_coupon_history.*')->where('draft_id',$customer_draft_Id)->get();
                     if($configurationDiscountSum !=  0){
               ...
               @if($customer->pay_later== "Yes")
                  @php  $a= 4;  $b=4;  $c=8; @endphp
               @else
                  @php  $a = 6; $b=3; $c=9;@endphp
               @endif
               <div class="col-md-12">
                  <div class="row">
                     <div class="col-md-{{$c}}">
