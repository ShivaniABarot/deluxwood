	...
	<div class="row clearfix g-3">
		...
		<div class="col-lg-12">
			<div class="card mb-3">
				...
				<div class="card-body">
					<form action="{{url('customer-draft/store')}}" method="POST" id="custdraftForm" enctype="multipart/form-data">
						@csrf 
						<div class="row g-3 align-items-center">
							<div class="col-md-6">
								<label class="form-label">PO Number</label>
								<input type="text" class="form-control" name="po_number"  value="{{ old('po_number')}}" placeholder="please enter PO number">
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" name="designer" placeholder="please enter designer">
							...
							<!-- <div class="col-md-6">
								...
								<input type="text" class="form-control" name="showroom" placeholder="please enter showroom">
							...
							<div class="col-md-4">
								...
								<input type="text" class="form-control" name="client_email" placeholder="please enter client email">
						...
						<div class="col-md-4">
								...
								<input type="text" class="form-control" name="contact_no" placeholder="please enter contact">
						...
						<div class="col-md-4">
								...
								<input type="text" class="form-control" name="zip_code" placeholder="please eneter zip code">
						...
						<div class="col-md-4">
								...
								<input type="text" class="form-control" name="ship_name"  value="{{ old('ship_name')}}" placeholder="please enter contact">
						...
						<div class="col-md-4">
								...
								<input type="text" class="form-control" name="ship_email"   value="{{ old('ship_email')}}" placeholder="please enter contact">
						...
						<div class="col-md-4">
								<label class="form-label">Contact No</label>
								<input type="text" class="form-control" name="ship_contact_no"  value="{{ old('ship_contact_no')}}" placeholder="please enter contact">
						...
						<div class="col-md-8">
								<label class="form-label">Address</label>
								<input type="text" class="form-control" name="ship_address"  value="{{ old('ship_address')}}" placeholder="please enter address">
						...
						<div class="col-md-4">
								<label class="form-label">City</label>
								<input type="text" class="form-control" name="ship_city"  value="{{ old('ship_city')}}" placeholder="please enter city">
						...
						<div class="col-md-4">
								<label class="form-label">Zip Code</label>
								<input type="text" class="form-control" name="ship_zip_code"  value="{{ old('ship_zip_code')}}" placeholder="please eneter zip code">
