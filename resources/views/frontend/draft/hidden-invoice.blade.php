...
<!-- Hidden One page  Without Price PDF Generate Start -->
      ...
      <div class="card" style="border-color: #FFFFFF;">
         <div class="card-body">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
               ...
               <div class="" style="border: 1px solid #000000;width: 33.0%;padding: 1px;">
                  <p class="title" style="border-bottom: 1px solid #000000; padding: 3px;font-size: 16px;font-weight: Bold;">Sales Order - #{{$customer_draft_Id}}</p>
                  <!-- <h6 style="border-bottom: 1px solid #000000; padding: 3px;"><b>Bill To</b></h6> -->
                  <!-- <hr> -->
            ...
            <div class="col-md-12 pd_cls">
               <div class="row">
                  <div class="col-md-4 bllvr_cls">
                     <p class="title" style="border-bottom: 1px solid #000000; padding: 3px;font-size: 13px;font-weight: Bold;">Bill To</p>
                     <!-- <h6 style="border-bottom: 1px solid #000000; padding: 3px;"><b>Bill To</b></h6> -->
                     <!-- <hr> -->
                  ...
                  <div class="col-md-4 bllvr_cls" style="margin-top:-3px;width: 32.10%;">
                     <p class="title" style="border-bottom: 1px solid #000000; padding: 3px;font-size: 13px;font-weight: Bold;">Ship To</p>
                     <!-- <h6 style="border-bottom: 1px solid #000000; padding: 3px;"><b>Ship To</b></h6> -->
                     <!-- <hr> -->
         ...
         <table style="width:99%;border:1px solid #000000;  border-width: 0px;margin-left: 2px;">
            <tr>
               <th class="per_cls" style="font-size:11px;font-weight:600">PROJECT DATE</th>
               <th class="per_cls" style="font-size:11px;font-weight:600">PO NUMBER</th>
               <th class="per_cls" style="font-size:11px;font-weight:600">DESIGNER</th>
               ...
               <th class="per_cls" style="font-size:11px;font-weight:600">SHIP DATE</th>
            </tr>
            <tr>
                  ...
                  <div class="col-lg-12">
                     <div class="row">
                        <div class="col-md-12">
                           ...
                           <p class="text" style="font-size: 10px;padding: 3px;border: 1px solid #000000; width: 68%;background-color: #dddddd;">
                              @php
                              $doorStyle = \App\Models\DoorStyle::find($doorStylewith);
                              @endphp
         ...
         <table class="tbl">
            <tr>
               <th class="thtd_cls text-center">No</th>
               ...
               <th class="thtd_cls text-center">HS</th>
               <th class="thtd_cls text-center">FE</th>
            </tr>
            @php $sub_total = 0; @endphp
            @php
            $no = 1;
         ...
         <?php $i++; ?>
         @endforeach
         <div style="border: 1px solid #000000;margin-top: 26px;">
            <p class="thn_cls" style="font-size: 12px;">* The estimated time your order will be ready for pick up is 5 BUSINESS DAYS Excluding Holidays Closing Days from the time we receive your signature.                       
               <br><br>
               ...
               <br><br>
               - - Inventory pending … will confirm order…
            </p>
         </div>
         <div class="col-md-12" style="margin-top: 120px;">
            <div class="row">
               <div class="col-md-8 resp_cls" style="padding-right: 0px;">
                  <div class="grd_cls" style="padding: 13px 5px 0px 9px;border: 1px solid #000000;">
                     <p class="" style="font-size: 12px;">All paid and signed orders will be responded to within 24 hours.
...
<!-- Hidden One page  Without Price PDF Generate End -->
<!-- Hidden One page  With Price PDF Generate Start -->
<div class="row g-3 mb-3" id="invoice" style="display: block;">
   <div class="col-md-12">
      <div class="card" style="border-color: #FFFFFF;">
         <div class="card-body">
            <div class="d-flex align-items-center justify-content-between flex-wrap logo_div" id="logo_div">
               <img src="{{asset('public/logo.png')}}" class="lg_cls">
               <div class="" style="border: 1px solid #000000;width: 33.0%;padding: 1px;">
                  <p class="title" style="border-bottom: 1px solid #000000; padding: 3px;font-size: 16px;font-weight: Bold;">Sales Order - #{{$customer_draft_Id}}</p>
                  <p class="fn_cls">420 Frontage Rd, West Haven<br>CT 06516, USA<br><b>Email:</b> info@deluxewoodcabinetry.com<br><b>Phone:</b> (475) 655-2687</p>
         ...
         <table style="width:98.50%;margin-left: 2px;border-collapse: collapse;" class="ppd_cls">
            <tr>
                  ...
                  <div class="col-lg-12">
                     <div class="row">
                        <div class="col-md-12">
                           ...
                           <p class="text" style="font-size: 10px;padding: 3px;border: 1px solid #000000; width: 68%;background-color: #CBCBCB; color: #000000;">
                              @php
                              $doorStyle = \App\Models\DoorStyle::find($doorStylewith);
                              @endphp
                              CAB. Style: {{ $doorStyle->name }}
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <table width="100%" height="100%" style="border: 1px solid #000000; background-color: #CBCBCB;font-size: 10px;font-weight: 600;">
                     ...
                     <tr>
                        <td colspan="3" class="prc_cls" style="padding-bottom: 7px;">Subtotal</td>
                        <td class="prc_cls" style="padding-bottom: 7px;">${{ number_format($sub_total, 2, '.', '') }}</td>
                     </tr>
                  </table>
               </div>
               <div class="col-6" style="padding-top: 11px;"></div>
               <div class="col-md-6" style="padding-top: 10px;">
                  <table width="100%" height="100%" style="border: 1px solid #000000; font-size: 10px;font-weight: 600;">
                     @if($customer_draft->configuration == "Unassembled")
                     <tr>
                        <td class="prc_cls" colspan="3" style="padding-top: 7px;">Unassembled Discount</td>
                        <td class="prc_cls" style="padding-top: 7px;">8 %</td>
                     </tr>
                     @endif
                     <tr>
                     ...
                     @endif
                     <td colspan="3" class="prc_cls" style="padding-bottom: 7px;">Total</td>
                     <td class="prc_cls" style="padding-bottom: 7px;">${{ number_format($discountedPrice, 2, '.', '') }}</td>
                     </tr>
                  </table>
               </div>
            </div>
      ...
      <div class=" " style="border: 1px solid #000000;margin-top: 50px;">
      ...
      <div class="col-md-12" style="margin-top: 50px;">
         <div class="row">
            <div class="col-md-8 resp_cls" style="padding-right: 0px;height: 59px;">
               <div class="grd_cls" style="padding: 4px 5px 0px 9px;border: 1px solid #000000;">
                  <p class="" style="font-size: 8px;font-weight: 600;">All paid and signed orders will be responded to within 24 hours.
                     <br>  <b>Return policy:</b>   
                     <br>
                     Customized cabinets are final sale. Regular returns are subject to a 35% restocking fee. In the event that you received the wrong 
                     merchandise or your merchandise arrived damaged, you must report this within 72 hours to qualify for a cost free replacement.
            ...
            <div class="col-md-4" style="padding-left: 0px; height: 59px;">
               <div class="nt" style="border-top: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;padding: 2px;height: 100%;">
                  <hr style="width: 68%; float: right; border-color: black;opacity : 0.80;">
                  <h6 style="padding: 5px; font-size: 12px; font-weight: 700;">Name</h6>
                  <hr style="width: 68%; float: right; border-color: black;opacity : 0.80;">
                  <h6 style="padding: 5px; font-size: 12px; font-weight: 700;">Signature</h6>
               </div>
            </div>
         </div>
      </div>
      <p style="text-align: right;font-size: 10px">{{$pdf_data->created_at}}</p>
   </div>
</div>
<!-- With Price Pdf End -->
@endsection
...
<script type="text/javascript">
   ...
   html2pdf().from(element).set(opt).toPdf().get('pdf').then(function (pdf) {
    ...
    for (i = 1; i <= totalPages; i++) {
      ...
      // Adjust the y-coordinate for bottom placement with 10px margin
      pdf.text('Page ' + i + ' of ' + totalPages, (pdf.internal.pageSize.getWidth() / 2.3), (pdf.internal.pageSize.getHeight() - 0.1)); // Increased y-coordinate for lower placement
