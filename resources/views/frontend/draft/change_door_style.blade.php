                  ...
                  <div class="card">
                     <div class="card-body">
                        <div class="product-details">
                                       ...
                                       <div class="col_lg_4 pd_cls selected_div" id="imageContainer_{{$i}}">
                                          <div class="single-item">
                                             <div class="items-image" id="imageContainer">
                                                <img src="{{ asset('public/img/door_style/' . $val['image']) }}" id="getimg" class="imgage" alt="product" style="width: 140px; height: 161px;">
                           ...
                           <div class="mt-4">
                              <form action="{{url('add-draft/change')}}/{{$id}}/{{$draft_style_id}}"  method="Post">
                                 @csrf
                                 ...
                                 <table>
                                    <tbody>
                                       ...
                                       <tr><button  type="submit"  class="btn btn-lg btn-block btn-light text-uppercase nx_cls">Next</button></tr>
                                    </tbody>
                                 </table>
                              </form>
                           </div>
